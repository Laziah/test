        ...
        <div className="card">
            <div className="row" id="form-height">
                <div className="col-sm-7 margin" id="back-img">
                    <p id="para-0">
                    <span id="smart" style={{ color: 'white' }}>STREAMLINE BACK OFFICE</span><br />
                        Facilitates seamless back-office management, planning,<br /> and scheduling,
                        ensuring the delivery of uncompromising <br /> quality, right on time.
                    </p>
                </div>
                <div className="col-sm-4 margin">
                    ...
                    <form name="signup_form" id="signup_form" onSubmit={handleSubmit}>
                        <div className="form-group">
                            ...
                            />
                            <span className="error" id="emailerror">{error && error}</span>
                        </div>
                        <div className="form-group">
